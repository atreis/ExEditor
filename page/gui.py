...
class DialogAdvancedEdit:
    ...
    def __init__(self, top, item):
        ...
        self.TLabel1.configure(text='''String:''')
        self.TLabel1.configure(anchor=E)

        self.TLabel2 = ttk.Label(top)
        self.TLabel2.place(relx=0.01, rely=0.55, height=29, width=65)
        self.TLabel2.configure(background="#d9d9d9")
        self.TLabel2.configure(foreground="#000000")
        self.TLabel2.configure(relief=FLAT)
        self.TLabel2.configure(text='''Integer:''')
        self.TLabel2.configure(anchor=E)

        self.TLabel3 = ttk.Label(top)
        self.TLabel3.place(relx=0.01, rely=0.65, height=29, width=65)
        ...
        self.TLabel4.place(relx=0.01, rely=0.75, height=29, width=65)
        ...
        self.Entry2.place(relx=0.13, rely=0.55, relheight=0.06, relwidth=0.85)
        ...
        valueint = dialog_support.valueint
        self.Entry2.configure(textvariable=valueint)
